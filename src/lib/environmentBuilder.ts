...
export const ENV = {
  MARGIN_END: 40000,    // clear floor at the aisle-entrance ends (X)
  MARGIN_SIDE: 70000,   // clear floor flanking the outer rack rows (Z)
...
export function buildEnvironment(
  ...
  const floorMat = new THREE.MeshStandardMaterial({ color: ENV_COLORS.floor, roughness: 0.95, metalness: 0 });
